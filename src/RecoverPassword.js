...
<View style={styles.textMain}>
          ...
          <Text style={styles.textTxt}>Recover Password</Text>
...
<View style={styles.inputMain}>
        ...
        <TouchableOpacity style={styles.forgotbtn} onPress={()=>navigation.goBack()} ><Text style={styles.forgottxt}>Resend Otp</Text></TouchableOpacity>
        <View style={styles.inputMain}>
            ...
            <View style={styles.inputTxtMain}>
                ...
                <TextInput style={styles.input}  secureTextEntry  value={Password} onChangeText={PasswordChange} placeholder='Enter password here'/>
            </View>
        </View>
        <View style={styles.inputMain}>
            <View style={styles.formImgMain}><Image style={styles.formImg} source={require('../assets/password_logo.png')}/></View>
            <View style={styles.inputTxtMain}>
                ...
                <TextInput style={styles.input} secureTextEntry  value={confirmPassword} onChangeText={confirmPasswordChange} placeholder='Enter password here'/>
            </View>
        </View>
        <TouchableOpacity style={styles.submitBtn} onPress={()=>navigation.navigate('Login')}>
            <Text style={styles.submitTxt} >RECOVER PASSWORD</Text>
        </TouchableOpacity>
    </View>
    </ImageBackground>
    </View>
