...
import { CreateFarmerRecord } from "./store/actions/FarmRecord";
...
const FarmRecord = ({ navigation }) => {
  ...
  const createFarmRecord = async () => {
    ...
    await dispatch(CreateFarmerRecord(data));
  };
      ...
      <View style={styles.containerMain}>
        ...
        <ScrollView>
          <View style={{ marginBottom: 20 }}>
            ...
            <View>
              <TouchableOpacity style={styles.inputMain} onPress={onSelect}>
                <View style={styles.formImgMain}>
                  <Image
                    style={styles.formImg}
                    source={require("../assets/date_logo.png")}
                  />
                </View>
                <View style={styles.inputTxtMain}>
            ...
            <TouchableOpacity onPress={createFarmRecord} style={styles.submitbtn}>
              <Text style={styles.btnTxt}>{i18n.t("Add_record")}</Text>
            </TouchableOpacity>

            <View style={styles.downloadFileMain}>
              <View style={styles.downloadFileHeadingMain}>
                <Text style={styles.downloadFileHeading}>
                  {i18n.t("Download_file")}
                </Text>
              </View>
              <TouchableOpacity
                style={styles.inputMainDownload}
                onPress={fromDateSelect}
              >
                <View style={styles.formImgMain}>
                  <Image
                    style={styles.formImg}
              ...
              <TouchableOpacity style={styles.submitbtn}>
                <Text style={styles.btnTxt}>{i18n.t("Download")}</Text>
              </TouchableOpacity>
            </View>
