          ...
          <View style={styles.headerHeadingMain}>
            <TouchableOpacity style={styles.headerBackIcon}>
              <ImageBackground
                ...
                source={{
                  uri: "https://static.remove.bg/remove-bg-web/ae6b8283273faa78bde35427479e843110cb3144/assets/start_remove-c851bdf8d3127a24e2d137a55b1b427378cd17385b01aec6e59d5d4b5f39d2ec.png",
                }}
              ></ImageBackground>
            </TouchableOpacity>
            ...
            {data.map((item, ind) => {
              return (
                <TouchableOpacity
                  ...
                  onPress={() => navigation.navigate(item.functionA)}
                >
