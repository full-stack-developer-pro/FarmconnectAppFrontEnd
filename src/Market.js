  ...
  <View style={styles.inputMain}>
            ...
            <View style={styles.inputMainTextarea}>
                ...
                <View style={styles.inputTxtMainTextArea}>
                    ...
                    <TextInput style={styles.input} value={Discription} onChangeText={DiscriptionChange} placeholder={`${i18n.t('Type_here')}....`}/>
                </View>
            </View>
            <View style={styles.inputMain}>
            ...
            FormData.map((item,ind)=>{
                return(
                   ...
                   {item.submitimage && <Image style={styles.AnnouncementImg} source={{uri:item.submitimage}}/>}
                    <View style={styles.DetailsTxtMain}><Text style={styles.AnnouncementHeading}>{item.submitTitle}</Text>
                   <Text style={styles.discriptionTxt}>{item.submitDiscription}</Text></View>
                  <TouchableOpacity  style={styles.TrainigIconMain} onPress={getIndex(ind)} key={ind}>
                    ...
                    <TouchableOpacity style={styles.priceBtn}>
                        <Text style={styles.priceTxt}>{`Price $ ${item.submitPrice}`}</Text>
                    </TouchableOpacity>
